...
function bravada_body_classes( $classes ) {
	...
	if ( ( ( is_archive() && !function_exists( 'is_shop' ) ) || ( is_archive() && !is_shop() ) ) && cryout_get_option('theme_meta_blog_byline') == 2 ) {
		$classes[] = 'bravada-desc-in-content';
	}
...
.bravada-striped-table .main thead th,
.bravada-bordered-table .main thead th,
.bravada-striped-table .main td, .bravada-striped-table .main th,
...
.bravada-striped-table .main tr:nth-child(even) td,
.bravada-striped-table .main tr:nth-child(even) th {
